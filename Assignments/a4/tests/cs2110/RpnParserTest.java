...
class RpnParserTest {
    ...
    void testParseOperation()
        ...
        // recursive case
        Expression expr2 = RpnParser.parse("y 1 + 2 z * /", Map.of());
        assertEquals(0.5, expr2.eval(vars));

        // negative numbers
        Expression expr3 = RpnParser.parse("y 3 - 2 z * +", Map.of());
        assertEquals(5, expr3.eval(vars));
