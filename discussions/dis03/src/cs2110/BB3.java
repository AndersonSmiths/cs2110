 ...
 */
public class BB3 implements BoundingBox {
     ...
     */
    public BB3(Point lower, Point upper) {
    ...
    public BoundingBox intersect(BoundingBox b) {
        ...
        if ((xMin > xMax) || (yMin > yMax)) {
            ...
            return new BB3(new Point(), new Point());
        }
        return new BB3(new Point(xMin, yMin), new Point(xMax, yMax));
    }
    ...
    public BoundingBox scale(double s) {
        ...
        return new BB3(lower.shifted(-0.5 * dw, -0.5 * dh),
    ...
    public BoundingBox shifted(double dx, double dy) {
        ...
        return new BB3(lower.shifted(dx, dy),
                upper.shifted(dx, dy));
    }
