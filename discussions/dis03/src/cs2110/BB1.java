 ...
 */
public class BB1 implements BoundingBox {
     ...
     */
    public BB1(Point lower, Point upper) {
    ...
    public BoundingBox intersect(BoundingBox b) {
        ...
        if ((xMin > xMax) || (yMin > yMax)) {
            ...
            return new BB1(new Point(), new Point());
        }
        return new BB1(new Point(xMin, yMin), new Point(xMax, yMax));
    }
    ...
    public BoundingBox scale(double s) {
        ...
        return new BB1(lower.shifted(-0.5 * dw, -0.5 * dh),
    ...
    public BoundingBox shifted(double dx, double dy) {
        ...
        return new BB1(lower.shifted(dx, dy),
                upper.shifted(dx, dy));
    }
